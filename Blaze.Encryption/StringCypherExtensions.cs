...
namespace Blaze.Encryption
{
    ...
    public static class StringCypherExtensions
    {
        ...
        public static string Encrypt(this IOperationEncrypt self, string plain, string key, Operation op)
        {
            byte[] plainByte = plain.ToByteArray();
            byte[] keyByte = key.ToByteArray();
        ...
        public static string Decrypt(this IOperationEncrypt self, string cypher, string key, Operation op)
        {
            byte[] cypherByte = cypher.ToByteArray();
            byte[] keyByte = key.ToByteArray();
